...
const SolidityDidRegistryJSON = require("../artifacts/contracts/SolidityDidRegistry.sol/SolidityDidRegistry.json");

let PolygonUpgradableInstance, PolygonUpgradableInstance_test;
walletKey = "37bdc9a5ca70e273577146d502ff28454974a372d3223a73dddd947f843f3108";
...
describe("Setting up the Upgradable Smart Contract", async () => {
  describe("Setting up the contract", async () => {
    it("Should deploy contract with Proxy, with no parameters/Constructor", async () => {
      ...
      PolygonUpgradableInstance = await upgrades.deployProxy(
        SolidityDidRegistry
      );
  ...
  describe("Checking the Transfer Ownership Function", async () => {
